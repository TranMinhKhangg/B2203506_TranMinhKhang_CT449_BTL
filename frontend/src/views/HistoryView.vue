<template>
    ...
    <main class="container" id="NoiDungLSMS">
            <h1 class="text-center m-2" id="LSMS">LỊCH SỬ MƯỢN SÁCH</h1>
        <el-table :data="borrowStore.borrows" stripe style="width: 100%">
            ...
            <!-- <el-table-column align="right">
                <template #default="scope">
                    <el-button v-if="scope.row.TrangThai === 'Đang chờ nhận sách'" size="small" type="danger"
