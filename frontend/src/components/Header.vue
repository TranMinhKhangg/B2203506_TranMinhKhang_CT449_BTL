            ...
            <div class="row inner-wrap">
                <div class="col-md-2 logo-box">
                    <div class="main-logo" data-aos="fade-right">
                        <router-link to="/">
                            <img src="../assets/image/icons8-book-50.png" class="logo" />
                        </router-link>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="search">
                        <input type="text" class="input-search" id="TimKiem" placeholder="Nhập tên sách để tìm kiếm..."
                            v-model="bookStore.searchText">
                        <img src="../assets/image/icons8-search-50.png" alt="" class="icon-timKiem">
                    </div>
                </div>
                <div class="main-menu col-4 col-md-4">
                    <ul class="menu-list">
                        <li class="menu-item TrangChu"><router-link to="/"
                                :class="`${routeBookCheck() == 'home' ? 'active' : ''}`">Trang chủ</router-link></li>
                        <li class="menu-item LichSuMuonSach"><router-link to="/history"
                ...
                <div class="btn-group col-md-2 button-header" v-if="!user.token">
                    <div class="login-box1">
                        <div class="noiDungform">
                            <img src="../assets/image/icons8-user-30.png" alt="" class= "iConDangNhapKH">
                            <button type="button" class="btn button-header-item" @click="handleNavigateToLogin">
                                Đăng nhập
                            </button>
                        </div>
                    </div>
                    <div class="login-box2">
                        <div class="noiDungform">
                            <img src="../assets/image/icons8-admin-30.png" alt="" class="iConDangNhapAdmin">
                            <button type="button" class="btn button-header-item" @click="handleNavigateToLoginManager">
                                Đăng nhập
                            </button>
                        </div>
                    </div>
