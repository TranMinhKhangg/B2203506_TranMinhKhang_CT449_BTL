    ...
    <div class="container">
        <div class="loginContainer" data-aos="fade-up">
            <div class="loginBox">
                ...
                <button type="button" class="btn btn-primary mt-2 button-submit" @click="submit" id="NutDangNhap">Đăng ký</button>
                <span class="mt-4">Nếu đã có tài khoản? <router-link to="/login" id="NutDangKy"><span>Đăng
